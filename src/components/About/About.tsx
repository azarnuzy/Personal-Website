      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2">
          ...
          <p className="mx-5 font-medium text-lg text-dark-gray-2 text-justify">
            I am computer science student who has enthusiasm for something new
            about technology and highly motivated to become lifelong learner.
            Proficient in team collaboration, problem solving, good
            communication, likes to find new challenges and experiences.
          </p>
        </div>
